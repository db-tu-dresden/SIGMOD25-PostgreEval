...
def execute_single_iteration(workload: workloads.Workload, *, database: postgres.PostgresInterface,
                             prewarm: bool = False) -> pd.DataFrame:
...
def execute_multiple_iterations(workload: workloads.Workload, *, database: postgres.PostgresInterface, repetitions: int = 1,
                                prewarm: bool = False, shuffled: bool = False) -> pd.DataFrame:
    ...
    for i in range(repetitions):
        ...
        current_df = execute_single_iteration(workload, database=database, prewarm=prewarm)
